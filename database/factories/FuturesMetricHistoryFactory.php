...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\FuturesMetricHistory>
 */
class FuturesMetricHistoryFactory extends Factory
{
    protected $model = FuturesMetricHistory::class;
